...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Admin', 'Application', 'Lecture', 'LecturesUsers', 'Meeting', 'MeetingsUsers', 'Reading', 'Survey', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Application', 'Lecture', 'LecturesUsers', 'Meeting', 'MeetingsUsers', 'Reading', 'Survey', 'User']
  ...
  #     configure :approves_aplications, :boolean 
  #     configure :schedules_lectures, :boolean 
  #     configure :arranges_meetings, :boolean 
  #     configure :upgrades_users_to_organization_members, :boolean 
  ...
  #     configure :author_full_name, :string 
  ...
  #     configure :description, :text 
  #     configure :lecture_date, :date 
  #     configure :lecturer, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'LecturesUsers' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your lectures_users.rb model definition
  ...
  #     configure :id, :integer 
  #     configure :lecture_id, :integer         # Hidden 
  #     configure :user_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'MeetingsUsers' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your meetings_users.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your reading.rb model definition
  ...
  #     configure :description, :text 
  #     configure :votes_for, :integer 
  #     configure :is_reworked, :boolean 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :knkf_member, :boolean 
  #     configure :meeting_id, :integer 
