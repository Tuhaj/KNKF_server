...
Admin.create(full_name: "Tadeusz Kościuszko", approves_aplications: true, schedules_lectures: true, arranges_meetings: true, upgrades_users_to_organization_members: true)
